...
public class Story_Level2_Single extends JPanel {

    private Tetris_Label game1;

    private Timer blockTimer;
    private int blockIndex = 21;
    ...
    private void reset() {
        ...
        this.blockTimer = new Timer(5000, new ActionListener(){

            @Override
            public void actionPerformed(ActionEvent e) {
                game1.block(blockIndex--);
            }
        ...
        this.timer1 = new Timer(currentFrequency1, new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(result==-1)
                {
                    if(game1.getLastIndex()>=blockIndex){
                        blockTimer.restart();
                    }
                    updateSequences();
